...
class TestKeyboard:
    ...
    def test_direction(self):
        ...
        assert self.kb.get_direction() is True, 'Failed to set direction to True'
        
        self.kb.set_direction(False)
        assert self.kb.get_direction() is False, 'Failed to set direction to False'

    def test_rainbow(self):
        self.kb.set_rainbow(True)
        assert self.kb.get_rainbow() is True, 'Failed to set rainbow to True'
        
        self.kb.set_rainbow(False)
        assert self.kb.get_rainbow() is False, 'Failed to set rainbow to False'
